from LuggageProcessing import countOfAllContainerBags,countTotalNumberOfBagCanBeContained
...
############################Part 1##################################
assert(4 == countOfAllContainerBags(testBagRules, "shiny gold"))

print(countOfAllContainerBags(inputBagRules, "shiny gold"))
...
assert(126 == countTotalNumberOfBagCanBeContained(testBagRules, "shiny gold"))

print(countTotalNumberOfBagCanBeContained(inputBagRules, "shiny gold"))
