from CustomsDeclaration import countOfQuestionsInAGroupAnsweredYes, questionWhichAnyoneAnsweredYes, questionWhichEveryoneAnsweredYes

############################Input###################################

inputAnswersMultipleGroups = [
    "jmcvr",
    "marvj",
    "",
    "doh",
...
testAnswersSingleGroup = [
    "abcx",
    "abcy",
    "abcz"
]
testAnswersMultipleGroups = [
    "abc",
    "",
    "a",
    "b",
...
############################Part 1##################################
assert(6 == countOfQuestionsInAGroupAnsweredYes(testAnswersSingleGroup, questionWhichAnyoneAnsweredYes))
assert(11 == countOfQuestionsInAGroupAnsweredYes(testAnswersMultipleGroups, questionWhichAnyoneAnsweredYes))

print(countOfQuestionsInAGroupAnsweredYes(inputAnswersMultipleGroups, questionWhichAnyoneAnsweredYes))
############################Part 2##################################
assert(6 == countOfQuestionsInAGroupAnsweredYes(testAnswersMultipleGroups, questionWhichEveryoneAnsweredYes))

print(countOfQuestionsInAGroupAnsweredYes(inputAnswersMultipleGroups, questionWhichEveryoneAnsweredYes))
