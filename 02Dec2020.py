from PassWordPolicy import countOfValidPassword, characterCountPasswordPolicy, exactlyOneCharacterPasswordPolicy

############################Input###################################
inputPasswordPolicies = {
...
############################Part 1##################################
assert (2 == countOfValidPassword({
    "1-3 a:abcde",
    "1-3 b:cdefg",
    "2-9 c:ccccccccc"
}, characterCountPasswordPolicy))

print(countOfValidPassword(inputPasswordPolicies, characterCountPasswordPolicy))
############################Part 2##################################
assert (1 == countOfValidPassword({
    "1-3 a:abcde",
    "1-3 b:cdefg",
    "2-9 c:ccccccccc"
}, exactlyOneCharacterPasswordPolicy))

print(countOfValidPassword(inputPasswordPolicies, exactlyOneCharacterPasswordPolicy))
